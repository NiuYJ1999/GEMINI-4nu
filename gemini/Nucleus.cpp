...
// short unsigned CNucleus::Zshell = 5;//niuyujie modified in 2024.5.24
short unsigned CNucleus::Zshell = 9;//niuyujie modified in 2024.5.17
...
//15N result ->14N
*/
  // if (lightP->residue.iZ == 7 && lightP->residue.iA == 14) {
  //     lightP->fShell = -0.79;
  //     lightP->fPair = 8.79;
  // }
// 15N result ->12C
  // if (lightP->residue.iZ == 6 && lightP->residue.iA == 12) {
  //     lightP->fShell = 1.01;
  //     lightP->fPair = 1;
  // }
//end
